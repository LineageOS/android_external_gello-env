...
bool PasswordManagerClient::EncryptMatch(autofill::PasswordForm* preferred_match) {
  return false;
}

bool PasswordManagerClient::DecryptMatch(autofill::PasswordForm* preferred_match) {
  return false;
}
// SWE-feature-password-encryption
