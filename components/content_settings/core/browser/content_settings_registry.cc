...
std::set<ContentSetting> ValidSettings(ContentSetting setting1,
                                       ...
                                       ContentSetting setting3,
                                       ContentSetting setting4,
                                       ContentSetting setting5) {
  ContentSetting settings[] = {setting1, setting2, setting3, setting4, setting5};
  return std::set<ContentSetting>(settings, settings + arraysize(settings));
}
...
void ContentSettingsRegistry::Init() {
  ...
  Register(CONTENT_SETTINGS_TYPE_GEOLOCATION, "geolocation",
           ...
           WhitelistedSchemes(),
           ValidSettings(CONTENT_SETTING_ALLOW, CONTENT_SETTING_BLOCK,
                         CONTENT_SETTING_ASK, CONTENT_SETTING_ALLOW_24H),
  ...
  Register(CONTENT_SETTINGS_TYPE_WEBREFINER, "webrefiner",
           CONTENT_SETTING_ALLOW, WebsiteSettingsInfo::UNSYNCABLE,
           WhitelistedSchemes(),
           ValidSettings(CONTENT_SETTING_ALLOW, CONTENT_SETTING_BLOCK),
           WebsiteSettingsInfo::REQUESTING_ORIGIN_ONLY_SCOPE,
  ...
  Register(CONTENT_SETTINGS_TYPE_WEBDEFENDER, "webdefender",
           CONTENT_SETTING_ALLOW, WebsiteSettingsInfo::UNSYNCABLE,
           WhitelistedSchemes(),
           ValidSettings(CONTENT_SETTING_ALLOW, CONTENT_SETTING_BLOCK),
           WebsiteSettingsInfo::REQUESTING_ORIGIN_ONLY_SCOPE,
  ...
  Register(CONTENT_SETTINGS_TYPE_SECURE_CONNECT, "secure-connect",
           CONTENT_SETTING_ALLOW, WebsiteSettingsInfo::UNSYNCABLE,
           WhitelistedSchemes(),
           ValidSettings(CONTENT_SETTING_ALLOW, CONTENT_SETTING_BLOCK),
           WebsiteSettingsInfo::REQUESTING_ORIGIN_ONLY_SCOPE,
