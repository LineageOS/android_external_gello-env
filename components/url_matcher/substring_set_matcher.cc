...
SubstringSetMatcher::SubstringSetMatcher(bool clear_patterns_after_use)
    : clear_patterns_after_use_(clear_patterns_after_use) {
...
void SubstringSetMatcher::AhoCorasickNode::Optimize() {
  std::sort(matches_.begin(), matches_.end());
  auto last = std::unique(matches_.begin(), matches_.end());
  matches_.erase(last, matches_.end());
