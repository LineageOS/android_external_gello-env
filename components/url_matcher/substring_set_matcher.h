...
#include "components/url_matcher/simple_map.h"
...
class URL_MATCHER_EXPORT SubstringSetMatcher {
 public:
  SubstringSetMatcher(bool clear_patterns_after_use = false);
  ~SubstringSetMatcher();
 ...
 private:
  ...
  class AhoCorasickNode {
   public:
    ...
    typedef simple_map<char, uint32_t> Edges;
    typedef std::vector<StringPattern::ID> Matches;
  ...
  bool clear_patterns_after_use_;
  ...
  friend class SubstringSetMatcherTest;
};
