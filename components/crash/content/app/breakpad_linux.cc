...
void HandleCrashDump(const BreakpadInfo& info) {
...
#endif
  {
    ...
    writer.AddBoundary();
#ifdef LAST_CHANGE
    writer.AddPairString("browser_build_info", LAST_CHANGE);
    writer.AddBoundary();
#endif
#ifdef SWE_LAST_CHANGE
    writer.AddPairString("swe_revision", SWE_LAST_CHANGE);
    writer.AddBoundary();
#endif
#ifdef SWE_PRODUCT_VERSION
    writer.AddPairString("browser_version", SWE_PRODUCT_VERSION);
    writer.AddBoundary();
#endif
