...
# This gyp file contains the platform-specific optimizations for Skia
{
  'variables': {
      'variables': {
        'add_on_skia%':'<!(python <(DEPTH)/build/dir_exists.py ../third_party/libsweskia/)',
      },
      'add_on_skia%': '<(add_on_skia)',
      ...
      'include_dirs': [
        ...
        '../third_party/libsweskia/include',
      ],
   },
            ...
            [ 'arm_version >= 7 and (arm_neon == 1 or arm_neon_optional == 1)', {
              'dependencies': [
               ...
               'conditions': [
                 [ 'add_on_skia == "True"', {
                   'dependencies': [
                     '../third_party/libsweskia/libsweskia.gyp:sweskia',
                   ],
                   'variables' : {
                     'prebuilt%': '<!(python <(DEPTH)/build/dir_exists.py ../third_party/libsweskia/lib/target)',
                   },
                   'conditions': [
                     [ 'prebuilt == "True"', {
                       'link_settings': {
