...
// Boolean to check if Security updates are allowed to use cellular networks
const char kSecurityUpdatesCellularAllowed[] =
    "security_updates.cellular_updates_allowed";
...
const char kWebKitNightModeEnabled[] = "webkit.webprefs.enable_night_mode";
const char kWebKitPowersaveModeEnabled[] = "webkit.webprefs.enable_powersave_mode";
