...
const char kDisableSafeBrowsing[]           = "disable-safebrowsing";
...
// Allow the user to download media content instead of playing inline
const char kMediaDownload[]                 = "media-download";

// Allow operators to add additional header : Example UAProf
const char kHTTPHeaders[]                   = "http-headers";
