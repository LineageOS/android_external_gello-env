...
public class FirstRunActivity extends AppCompatActivity implements FirstRunPageDelegate {
    ...
    static final String SHOW_SAFE_BROWSING_PAGE = "ShowSafeBrowsingPage";
    static final String SHOW_SECURITY_MOBILE_UPDATE_PAGE = "ShowSecurityMobileUpdatePage";
    ...
    private void createPageSequence() {
        ...
        if (mFreProperties.getBoolean(SHOW_SAFE_BROWSING_PAGE)) {
            mPages.add(pageOf(SafeBrowsingFirstRunFragment.class));
        }

        if (mFreProperties.getBoolean(SHOW_SECURITY_MOBILE_UPDATE_PAGE)) {
            mPages.add(pageOf(SecurityUpdateFirstRunFragment.class));
        }
    }
