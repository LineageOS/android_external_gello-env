...
public class ContentSettingsResources {
    ...
    private static Map<Integer, ResourceItem> getResourceInfo() {
        ...
        if (sResourceInfo == null) {
            ...
            localMap.put(ContentSettingsType.CONTENT_SETTINGS_TYPE_WEBREFINER,
                    new ResourceItem(R.drawable.img_deco_smartprotect_webrefiner,
                            R.string.web_refiner_title, R.string.web_refiner_title,
                            ContentSetting.ALLOW, ContentSetting.BLOCK,
                            R.string.web_refiner_about_text, R.string.website_settings_category_disabled));
            localMap.put(ContentSettingsType.CONTENT_SETTINGS_TYPE_WEBDEFENDER,
                    new ResourceItem(R.drawable.img_deco_smartprotect_webdefender,
                            R.string.web_defender_title, R.string.web_defender_title,
                            ContentSetting.ALLOW, ContentSetting.BLOCK,
                            R.string.web_defender_about_text,
                            R.string.website_settings_category_disabled));
    ...
    public static int getSiteSummary(ContentSetting value) {
        switch (value) {
            ...
            case ALLOW_24H:
                return R.string.infobar_permission_allow_24h;
            default:
