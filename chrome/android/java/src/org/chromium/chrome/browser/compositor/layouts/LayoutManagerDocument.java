...
public class LayoutManagerDocument extends LayoutManager
    ...
    public LayoutManagerDocument(LayoutManagerHost host) {
        ...
        if (EdgeNavigationLayout.isEnabled()) {
            mEdgeNavigationLayout = EdgeNavigationLayout.getNewLayout(mContext, this, renderHost);
        }
        ...
        if (mEdgeNavigationLayout != null) {
            staticCascadeEventFilter = new CascadeEventFilter(mContext, this,
                    new EventFilter[]{mEdgeNavigationLayout.getEventFilter(), mStaticEdgeEventFilter});
        } else {
            staticCascadeEventFilter = new CascadeEventFilter(mContext, this,
                    new EventFilter[]{mStaticEdgeEventFilter});
        }
        ...
        mStaticLayout = new StaticLayout(
                mContext, this, renderHost, staticCascadeEventFilter, mOverlayPanelManager);
