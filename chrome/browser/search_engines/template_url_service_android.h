...
class TemplateUrlServiceAndroid : public TemplateURLServiceObserver {
 public:
  ...
  void AddSearchEngine(JNIEnv* env, jobject obj, jstring jtitle, jstring jkeyword,
    jstring jsearch_url, jstring jfavicon_url);
  void ClearPrepopulatedEnginesInPrefs();
  void MakeDefault(JNIEnv* env, jobject obj, jstring jkeyword);
  base::android::ScopedJavaLocalRef<jobject>
      GetPartnerTemplateUrlAt(JNIEnv* env, jobject obj, jint index);
