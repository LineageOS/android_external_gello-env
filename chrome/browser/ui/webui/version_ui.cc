...
WebUIDataSource* CreateVersionUIDataSource() {
  ...
  html_source->AddString("swe_cl", version_info::GetSWELastChange());
  html_source->AddLocalizedString("swe_product_name", IDS_ABOUT_SWE_PRODUCT_NAME);
  html_source->AddString("swe_ver_cl", version_info::GetSWEVersionNumber());
#else
