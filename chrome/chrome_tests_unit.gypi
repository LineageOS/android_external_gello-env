...
# found in the LICENSE file.
{
  'variables': {
    ...
    'chrome_unit_tests_full_safe_browsing_sources': [
      ...
      # Tests downloaded zip files, zip files are not supported on Android.
      ...
      # Extentions are not supported on Android, it is used for data collection.
      ...
      # Tests uploading stats to Google, this test only runs on linux using python.
      # The test is not supported on Android.
