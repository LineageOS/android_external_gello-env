...
bool ThemePainter::paint(const LayoutObject& o, const PaintInfo& paintInfo, const IntRect&r)
{
    ...
    case SliderBrightnessVerticalPart:
        return MediaControlsPainter::paintMediaSliderTrack(o, paintInfo, r, true);
    case SliderVolumeVerticalPart:
        return MediaControlsPainter::paintMediaSliderTrack(o, paintInfo, r, false);
    ...
    case MediaOverlayUnlockButtonPart:
        return MediaControlsPainter::paintMediaOverlayUnlockButton(o, paintInfo, r);
    case MediaOverlayDisplayPart:
        return MediaControlsPainter::paintMediaOverlayDisplay(o, paintInfo, r);
