...
void StyleResolver::collectFeatures()
{
    ...
    if (document().isDefaultExtraStyleSheet01Enabled() && defaultStyleSheets.defaultExtraStyle01())
        m_features.add(defaultStyleSheets.defaultExtraStyle01()->features());

    if (document().isDefaultExtraStyleSheet02Enabled() && defaultStyleSheets.defaultExtraStyle02())
        m_features.add(defaultStyleSheets.defaultExtraStyle02()->features());
...
void StyleResolver::matchUARules(ElementRuleCollector& collector)
{
    ...
    if (document().isDefaultExtraStyleSheet01Enabled() && defaultStyleSheets.defaultExtraStyle01())
        matchRuleSet(collector, defaultStyleSheets.defaultExtraStyle01());

    if (document().isDefaultExtraStyleSheet02Enabled() && defaultStyleSheets.defaultExtraStyle02())
        matchRuleSet(collector, defaultStyleSheets.defaultExtraStyle02());
