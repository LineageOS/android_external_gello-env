...
class CORE_EXPORT CSSDefaultStyleSheets : public GarbageCollected<CSSDefaultStyleSheets> {
...
public:
    ...
    StyleSheetContents* defaultExtraStyleSheet01() { return m_defaultExtraStyleSheet01.get(); }
    StyleSheetContents* defaultExtraStyleSheet02() { return m_defaultExtraStyleSheet02.get(); }
