...
public:
    ...
    void incrementSvgCounter() { m_svgCounter++; }
    int getSvgCounter() { return m_svgCounter; }
    ...
    */
    ...
    void heavyExecutionDetected(int duration, bool pageLoad = false) const;
    ...
    void* activityData() { return m_activityData; }
    ...
    void setIsDefaultExtraStyleSheet01Enabled(bool extra_stylesheet_enabled) { m_isDefaultExtraStyleSheet01Enabled = extra_stylesheet_enabled; }
    void setIsDefaultExtraStyleSheet02Enabled(bool extra_stylesheet_enabled) { m_isDefaultExtraStyleSheet02Enabled = extra_stylesheet_enabled; }
    bool isDefaultExtraStyleSheet01Enabled() { return m_isDefaultExtraStyleSheet01Enabled; }
    bool isDefaultExtraStyleSheet02Enabled() { return m_isDefaultExtraStyleSheet02Enabled; }
...
private:
    ...
    bool m_isDefaultExtraStyleSheet01Enabled = false;
    bool m_isDefaultExtraStyleSheet02Enabled = false;
};
