...
// Lookup a key in a byte array generated by make_dafsa.py.
// The value is returned if key is found, otherwise -1 is returned.
NET_EXPORT int LookupStringInDAFSA(const unsigned char* graph, size_t length,
