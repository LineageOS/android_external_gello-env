...
{ 'return_type': 'void',
  'versions': [{ 'name': 'glStartTilingQCOM',
                 'extensions': ['GL_QCOM_tiled_rendering'] }],
  'arguments': 'GLuint x, GLuint y, GLuint width, GLuint height, GLbitfield preserveMask', },
{ 'return_type': 'void',
...
{ 'return_type': 'EGLBoolean',
  ...
  'arguments': 'EGLDisplay dpy, EGLSurface surface', },
{ 'return_type': 'EGLBoolean',
  'versions': [{ 'name': 'eglSwapBuffersWithDamageKHR',
                 'extensions':
                     ['EGL_KHR_swap_buffers_with_damage'] }],
  'arguments': 'EGLDisplay dpy, EGLSurface surface, EGLint* rects, EGLint n_rects', },
{ 'return_type': 'EGLBoolean',
