...
void GLES2TraceImplementation::StartTilingQCOM(GLuint x,
                                               GLuint y,
                                               GLuint width,
                                               GLuint height,
                                               GLbitfield preserveMask) {
  TRACE_EVENT_BINARY_EFFICIENT0("gpu", "GLES2Trace::StartTilingQCOM");
  gl_->StartTilingQCOM(x, y, width, height, preserveMask);
}

void GLES2TraceImplementation::EndTilingQCOM(GLbitfield preserveMask) {
  TRACE_EVENT_BINARY_EFFICIENT0("gpu", "GLES2Trace::EndTilingQCOM");
  gl_->EndTilingQCOM(preserveMask);
}
