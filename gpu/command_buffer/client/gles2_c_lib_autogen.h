...
void GL_APIENTRY GLES2StartTilingQCOM(GLuint x,
                                      GLuint y,
                                      GLuint width,
                                      GLuint height,
                                      GLbitfield preserveMask) {
  gles2::GetGLContext()->StartTilingQCOM(x, y, width, height, preserveMask);
}
void GL_APIENTRY GLES2EndTilingQCOM(GLbitfield preserveMask) {
  gles2::GetGLContext()->EndTilingQCOM(preserveMask);
}
...
extern const NameToFunc g_gles2_function_table[] = {
    ...
    {
        "glStartTilingQCOM",
        reinterpret_cast<GLES2FunctionPointer>(glStartTilingQCOM),
    },
    {
        "glEndTilingQCOM",
        reinterpret_cast<GLES2FunctionPointer>(glEndTilingQCOM),
    },
    {
        NULL, NULL,
    },
