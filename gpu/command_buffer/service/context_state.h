...
struct GPU_EXPORT ContextState {
  ...
  bool doing_tiling;
  GLuint start_tiling_x;
  GLuint start_tiling_y;
  GLuint start_tiling_w;
  GLuint start_tiling_h;
  GLbitfield start_tiling_preserveMask;
  void RestoreTilingState(const ContextState* prev_state) const;
#endif
