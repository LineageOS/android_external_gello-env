...
#ifdef DO_TILED_RENDERING
void ContextState::RestoreTilingState(const ContextState* prev_state) const {
  if (doing_tiling) {
    glStartTilingQCOM(start_tiling_x, start_tiling_y, start_tiling_w, start_tiling_h, 0xffffffff);
  }
}
#endif
