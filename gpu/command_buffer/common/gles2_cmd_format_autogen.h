...
struct StartTilingQCOM {
  typedef StartTilingQCOM ValueType;
  static const CommandId kCmdId = kStartTilingQCOM;
  static const cmd::ArgFlags kArgFlags = cmd::kFixed;
  static const uint8_t cmd_flags = CMD_FLAG_SET_TRACE_LEVEL(3);
  ...
  void Init(GLuint _x,
            ...
            GLuint _width,
            GLuint _height,
            GLbitfield _preserveMask) {
    SetHeader();
    x = _x;
    y = _y;
    width = _width;
    height = _height;
    preserveMask = _preserveMask;
  }
  ...
  void* Set(void* cmd,
            ...
            GLuint _height,
            GLbitfield _preserveMask) {
    static_cast<ValueType*>(cmd)->Init(_x, _y, _width, _height, _preserveMask);
    return NextCmdAddress<ValueType>(cmd);
  }
...
static_assert(sizeof(StartTilingQCOM) == 24,
              "size of StartTilingQCOM should be 24");
static_assert(offsetof(StartTilingQCOM, header) == 0,
              "offset of StartTilingQCOM header should be 0");
static_assert(offsetof(StartTilingQCOM, x) == 4,
              "offset of StartTilingQCOM x should be 4");
static_assert(offsetof(StartTilingQCOM, y) == 8,
              "offset of StartTilingQCOM y should be 8");
static_assert(offsetof(StartTilingQCOM, width) == 12,
              "offset of StartTilingQCOM width should be 12");
static_assert(offsetof(StartTilingQCOM, height) == 16,
              "offset of StartTilingQCOM height should be 16");
static_assert(offsetof(StartTilingQCOM, preserveMask) == 20,
              "offset of StartTilingQCOM preserveMask should be 20");

struct EndTilingQCOM {
  typedef EndTilingQCOM ValueType;
  static const CommandId kCmdId = kEndTilingQCOM;
  static const cmd::ArgFlags kArgFlags = cmd::kFixed;
  static const uint8_t cmd_flags = CMD_FLAG_SET_TRACE_LEVEL(3);
  ...
  void Init(GLbitfield _preserveMask) {
    SetHeader();
    preserveMask = _preserveMask;
  }

  void* Set(void* cmd, GLbitfield _preserveMask) {
    static_cast<ValueType*>(cmd)->Init(_preserveMask);
    return NextCmdAddress<ValueType>(cmd);
  }
...
static_assert(sizeof(EndTilingQCOM) == 8, "size of EndTilingQCOM should be 8");
static_assert(offsetof(EndTilingQCOM, header) == 0,
              "offset of EndTilingQCOM header should be 0");
static_assert(offsetof(EndTilingQCOM, preserveMask) == 4,
              "offset of EndTilingQCOM preserveMask should be 4");
