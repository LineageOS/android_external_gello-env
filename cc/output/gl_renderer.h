...
class CC_EXPORT GLRenderer : public DirectRenderer {
 ...
 protected:
  ...
  void BeginDrawingRenderPass(DrawingFrame* frame, const RenderPass* render_pass, const gfx::Rect& render_pass_scissor) override;
  void FinishDrawingRenderPass(DrawingFrame* frame, const RenderPass* render_pass) override;
#endif
