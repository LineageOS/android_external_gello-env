...
class CC_EXPORT DirectRenderer : public Renderer {
 ...
 protected:
  ...
  virtual void BeginDrawingRenderPass(DrawingFrame* frame, const RenderPass* render_pass, const gfx::Rect& render_pass_scissor) {};
  virtual void FinishDrawingRenderPass(DrawingFrame* frame, const RenderPass* render_pass) {};
#endif
