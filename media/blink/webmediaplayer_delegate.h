 ...
 public:
  class Observer {
   public:
    ...
    virtual void OnDeltaSeek(int delta) = 0;
  ...
  virtual void AdjustBrightness(float delta) {}
  virtual void SetRotateLock(bool lock) {}

  virtual bool ShouldAllowBackgroundAudio() = 0;
