...
CONTENT_EXPORT extern const char kDisableWebDefender[];
...
CONTENT_EXPORT extern const char kDisableEnhancedVideoPlayer[];
...
CONTENT_EXPORT extern const char kDisableVideoPausing[];
...
CONTENT_EXPORT extern const char kEnableVideoPausing[];
