...
/* package */ class WebContentsImpl implements WebContents {
    ...
    @Override
    public void deltaSeekMediaSession(int delta) {
        nativeDeltaSeekMediaSession(mNativeWebContentsAndroid, delta);
    }
    ...
    private native void nativeDeltaSeekMediaSession(long nativeWebContentsAndroid, int delta);
