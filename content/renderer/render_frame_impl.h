...
#include "third_party/WebKit/public/platform/WebActivities.h"
...
class CONTENT_EXPORT RenderFrameImpl
    : public RenderFrame,
      ...
      NON_EXPORTED_BASE(public blink::WebActivitiesClient),
 ...
 public:
  ...
  blink::WebActivitiesClient* webActivitiesClient(blink::WebLocalFrame* frame) override;
  ...
  // WebActivitiesClient implementation:
  void onWebActivity(const blink::WebURL& fingerPrintUrl,
                             const blink::WebURL& firstPartyUrl,
                             int trackerType) override;
