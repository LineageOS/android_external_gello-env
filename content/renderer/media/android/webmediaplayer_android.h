...
class WebMediaPlayerAndroid
 ...
 public:
  ...
  void adjustBrightness(float) override;
  void setRotateLock(bool) override;
  void setFitVertical(bool) override;
  ...
  void OnBrightnessChanged(float brightness) override;
  void OnOrientationUpdated(bool isOrientationPortrait) override;
  ...
  void OnDeltaSeek(int delta) override;
