...
#include "third_party/WebKit/public/web/WebActivitiesForward.h"
...
void RenderThreadImpl::Init(
  ...
  WebRefiner::Get()->RegisterRenderThreadImpl(this);
...
void RenderThreadImpl::InitializeWebKit(
  ...
  blink::WebActivities::setForward(blink::WebActivitiesForward::get());
