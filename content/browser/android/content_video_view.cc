...
void ContentVideoView::OnBrightnessChanged(JNIEnv*,
                                           const JavaParamRef<jobject>&,
                                           float brightness) {
  client_->OnBrightnessChanged(brightness);
}

void ContentVideoView::OnOrientationUpdated(JNIEnv*,
                                            const JavaParamRef<jobject>&,
                                            bool isOrientationPortrait) {
  client_->OnOrientationUpdated(isOrientationPortrait);
}
