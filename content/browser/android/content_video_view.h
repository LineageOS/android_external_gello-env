 ...
 public:
  ...
  class Client {
   public:
    ...
    virtual void OnBrightnessChanged(float brightness) = 0;

    virtual void OnOrientationUpdated(bool isOrientationPortrait) = 0;
  ...
  void OnBrightnessChanged(JNIEnv*,
                           const base::android::JavaParamRef<jobject>&,
                           float);
  void OnOrientationUpdated(JNIEnv*,
                            const base::android::JavaParamRef<jobject>&,
                            bool);
