...
class CONTENT_EXPORT WebContentsImpl
 ...
 public:
  ...
  void DeltaSeekMediaSession(int delta) override;
  void OnMediaBrightnessChanged(float brightness) override;
  ...
  void HeavyExecutionDetected(int duration) override;
  ...
  void MediaAdjustBrightness(float delta);
  void MediaSetRotateLock(bool lock);
