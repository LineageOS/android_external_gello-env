...
bool RenderViewHostImpl::OnMessageReceived(const IPC::Message& msg) {
  ...
  IPC_BEGIN_MESSAGE_MAP(RenderViewHostImpl, msg)
    ...
    IPC_MESSAGE_HANDLER(ViewHostMsg_HeavyExecutionDetected, OnHeavyExecutionDetected)
...
void RenderViewHostImpl::OnHeavyExecutionDetected(int duration) {
  delegate_->HeavyExecutionDetected(duration);
}
