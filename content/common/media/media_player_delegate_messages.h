...
IPC_MESSAGE_ROUTED2(MediaPlayerDelegateMsg_DeltaSeek,
                    int /* delegate_id, distinguishes instances */,
                    int /* delta */)

IPC_MESSAGE_ROUTED2(MediaPlayerDelegateMsg_BrightnessChanged,
                    int /* delegate_id, distinguishes instances */,
                    float /* brightness */)
...
IPC_MESSAGE_ROUTED1(MediaPlayerDelegateHostMsg_OnMediaAdjustBrightness,
                    float /* brightness delta */)

IPC_MESSAGE_ROUTED1(MediaPlayerDelegateHostMsg_OnMediaSetRotateLock,
                    bool /* should lock rotation */)
