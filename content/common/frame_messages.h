...
IPC_MESSAGE_CONTROL5(FrameHostMsg_SetCookie,
                     int /* render_frame_id */,
                     int /* render_view_id */,
                     GURL /* url */,
...
IPC_SYNC_MESSAGE_CONTROL4_1(FrameHostMsg_GetCookies,
                            int /* render_frame_id */,
                            int /* render_view_id */,
                            GURL /* url */,
                            GURL /* first_party_for_cookies */,
...
IPC_SYNC_MESSAGE_CONTROL4_1(FrameHostMsg_CookiesEnabled,
                            int /* render_frame_id */,
                            int /* render_view_id */,
                            GURL /* url */,
                            GURL /* first_party_for_cookies */,
...
IPC_MESSAGE_CONTROL5(FrameHostMsg_OnWebActivity,
                     int /* render_frame_id */,
                     int /* render_view_id */,
                     GURL /* url */,
                     GURL /* fp_url */,
