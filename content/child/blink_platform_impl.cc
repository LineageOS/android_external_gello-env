...
const DataResource kDataResources[] = {
    ...
    {"mediaplayerLock", IDR_MEDIAPLAYER_LOCK_BUTTON, ui::SCALE_FACTOR_100P},
    ...
    {"mediaplayerFullscreenDisabled",
     ...
     ui::SCALE_FACTOR_100P},
    {"mediaplayerZoomFitVertical",
     IDR_MEDIAPLAYER_ZOOM_FIT_VERTICAL_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerZoomNormal",
     IDR_MEDIAPLAYER_ZOOM_NORMAL_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayBrightnessLevel3",
     IDR_MEDIAPLAYER_OVERLAY_BRIGHTNESS_LEVEL3_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayBrightnessLevel2",
     IDR_MEDIAPLAYER_OVERLAY_BRIGHTNESS_LEVEL2_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayBrightnessLevel1",
     IDR_MEDIAPLAYER_OVERLAY_BRIGHTNESS_LEVEL1_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayBrightnessLevel0",
     IDR_MEDIAPLAYER_OVERLAY_BRIGHTNESS_LEVEL0_BUTTON,
     ui::SCALE_FACTOR_100P},
    ...
    {"mediaplayerOverlaySoundLevel3",
     IDR_MEDIAPLAYER_OVERLAY_SOUND_LEVEL3_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlaySoundLevel2",
     IDR_MEDIAPLAYER_OVERLAY_SOUND_LEVEL2_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlaySoundLevel1",
     IDR_MEDIAPLAYER_OVERLAY_SOUND_LEVEL1_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlaySoundLevel0",
     IDR_MEDIAPLAYER_OVERLAY_SOUND_LEVEL0_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayUnlock",
     IDR_MEDIAPLAYER_OVERLAY_UNLOCK_BUTTON,
     ui::SCALE_FACTOR_100P},
