...
vars = {
  ...
  'pdfium_url':'git://codeaurora.org/quic/chrome4sdp/pdfium.git',
  'boringssl_url': 'git://codeaurora.org/quic/chrome4sdp/boringssl.git',
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'ed3c69244d9ec16463bb91aa47a6c51c61e974e6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f56c0733c8d2f854f803c94ca27ecca66458a6a9',
  # Three lines of non-changing comments so that
  ...
  'deqp_url': 'git://codeaurora.org/quic/chrome4sdp/platform/external/deqp',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'e48c81d763657566e81310fbf457465375260106',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/icu':
   Var('chromium_git') + '/chromium/deps/icu.git' + '@' + 'b31169b6865c7c796c897a925c4c904c6727c3ae',
  ...
  'src/v8':
    Var('webtech_devx_url') + '/v8.git' + '@' +  Var('v8_revision'),
  ...
  'src/third_party/pdfium':
   Var('pdfium_url') + '@' +  Var('pdfium_revision'),

  'src/third_party/boringssl/src':
    Var('boringssl_url') + '@' +  Var('boringssl_revision'),
...
hooks = [
  ...
  {
    'name': 'configure_web_refiner',
    'pattern': '.',
    'action': ['python', 'src/build/web_refiner_init.py'],
  },
  {
